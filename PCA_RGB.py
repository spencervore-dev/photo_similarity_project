...
# save_loc = "/home/spencervore/OneDrive/isye6740_project_data/results/image_recs/pixabay_transparent_pca_n2/"
# rec_save_loc = save_loc + "pixa-transparent-iso-"
# n_components = 2

path = "/home/spencervore/OneDrive/isye6740_project_data/pixabay/transparent"
images_to_rec = [0, 1, 2, 3, 100, 101, 102, 103, 104, 105, 106, 107, 150, 151, 152, 153, 154, 155, 156, 61, 11, 413, 380]
save_loc = "/home/spencervore/OneDrive/isye6740_project_data/results/image_recs/pixabay_transparent_pca_n6/"
rec_save_loc = save_loc + "pixa-transparent-iso-"
n_components = 6
...
plt.savefig(save_loc + 'pca_RGB.png')
# plt.show()
...
img_recommender(pca_imgs, flat_pics, images_to_rec, rec_save_loc, n_components=n_components, r=r, c=c)