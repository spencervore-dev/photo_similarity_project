...
for xs, ys in zip(pc_values, pca.explained_variance_ratio_):
    label = "{:.2f}".format(ys)
    plt.annotate(label, (xs, ys),
                 textcoords='offset points',
                 xytext=(0, 5))

#plt.savefig('C:/Users/lesea/OneDrive/Documents/GA Tech/Summer 2022/ISYE 6740/Project/pca_scree_plot_background.png')
plt.show()
...
if pc == 2:
    ...
    fig, ax = plt.subplots()
    plt.title('2D Plot Using PCA of RGB Animal Images with Transparent Backgrounds')
    ...
    plt.savefig('C:/Users/lesea/OneDrive/Documents/GA Tech/Summer 2022/ISYE 6740/Project/pca_RGB_transparent.png')
    plt.show()
...
count = 1
proj_folder = "C:/Users/lesea/OneDrive/Documents/GA Tech/Summer 2022/ISYE 6740/Project/PCA6_Clusters_background/"
for clust in clusters:
    fig = plt.figure(figsize=(10, 10), tight_layout=True)
    name = str('Cluster ' + str(count) + ' animals (with background) - PC = ' + str(pc))
    i = 1
    for im in clust:
        cols = 6
