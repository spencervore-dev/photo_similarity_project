...
#####################################################
######## ISOMAP with 6 neighbors and reduce to 2 dimensions (each image dimensions reduces to 2)
#####################################################
...
ax.set_title('2D Components from Isomap of Animal Images')
